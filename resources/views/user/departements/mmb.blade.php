...
@section('pageTitle', 'Multimedia Broadcasting')
@section('content')
{{-- <h2>sasasas</h2> --}}
<div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
    <div class="carousel-inner">
        <div class="carousel-item active">
            <img src="{{ asset('Bizland/assets/img/portfolio/a1.jpg') }}" class="d-block w-100" style="height: 600px">
        </div>
        <div class="carousel-item">
            <img src="{{ asset('Bizland/assets/img/portfolio/s.jpg') }}" class="d-block w-100" style="height: 600px">
        </div>
    </div>
